...
print(mat_name + '_range = mp.FreqRange(min=um_scale, max=um_scale/' + str(y_min) + ')')

print(mat_name + '_eps_inf = ' + str(x[0]) + '\n')

num = 1
for cc in range(0, int((res_O2.x.size - 1)/3)):
    print(mat_name + '_frq' + str(num) + ' = ' + str(res_O2.x[3*cc + 1]) + '/um_scale')
    print(mat_name + '_gam' + str(num) + ' = ' + str(res_O2.x[3*cc + 2]) + '/um_scale')
    print(mat_name + '_sig' + str(num) + ' = ' + str(res_O2.x[3*cc + 3]) + '\n')
    num = num + 1
...
#+RESULTS:
:results:
Hb_range = mp.FreqRange(min=um_scale, max=um_scale/400)
Hb_eps_inf = 1.9204612564867327

Hb_frq1 = 2.675987283315683/um_scale
Hb_gam1 = 0.04950632944837519/um_scale
Hb_sig1 = 0.0012972251822393197

Hb_frq2 = 2.4070729455988458/um_scale
Hb_gam2 = 0.14706747117176092/um_scale
Hb_sig2 = 0.0032028279707049514

Hb_frq3 = 1.848642923385006/um_scale
Hb_gam3 = 0.10167508053441751/um_scale
Hb_sig3 = 0.0003298885866370613

Hb_frq4 = 1.7360993706620067/um_scale
Hb_gam4 = 0.042151636251243255/um_scale
Hb_sig4 = 0.000158962228522564
...
Hb_susc.append(mp.LorentzianSusceptibility(frequency=Hb_frq4,gamma=Hb_gam4, sigma=Hb_sig4))
Hb_susc.append(mp.LorentzianSusceptibility(frequency=Hb_frq5,gamma=Hb_gam5, sigma=Hb_sig5))
...
#Start by defining hte frequency range:
print(mat_name + '_range = mp.FreqRange(min=um_scale, max=um_scale/' + str(y_min) + ')')

#Define all of the susceptibility and epsilon parameters:
print(mat_name + '_eps_inf = ' + str(x[0]) + '\n')
...
#+RESULTS:
:results:
HbO2_range = mp.FreqRange(min=um_scale, max=um_scale/400)
...
HbO2_susc.append(mp.LorentzianSusceptibility(frequency=HbO2_frq5,gamma=HbO2_gam5, sigma=HbO2_sig5))
