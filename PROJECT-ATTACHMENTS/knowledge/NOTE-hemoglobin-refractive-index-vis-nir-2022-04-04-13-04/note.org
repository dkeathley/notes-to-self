...
for cc in range(0, int((res_O2.x.size - 1)/3)):
    print('')
    print('alpha' + str(num) + ' = ' + str(res_O2.x[3*cc + 1]) + '\n')
    print('beta' + str(num) + ' = ' + str(res_O2.x[3*cc + 2]) + '\n')
    print('sigma' + str(num) + ' = ' + str(res_O2.x[3*cc + 3]) + '\n')
    num = num + 1
#+end_src
...
alpha2 = 1.8486922806894537

beta2 = 0.10159641025659066

sigma2 = 0.0003281708702105979


alpha3 = 1.7361677182741297

beta3 = 0.04191495309787554

sigma3 = 0.00015769098503934817
...
HbO2_frq1 = 2.450224416259269/um_scale
HbO2_gam1 = 0.13423579986810846/um_scale
HbO2_sig1 = 0.004352150925594353

HbO2_frq2 = 1.8486922806894537/um_scale
HbO2_gam2 = 0.10159641025659066/um_scale
HbO2_sig2 = 0.0003281708702105979

HbO2_frq3 = 1.7361677182741297/um_scale
HbO2_gam3 = 0.04191495309787554/um_scale
HbO2_sig3 = 0.00015769098503934817
